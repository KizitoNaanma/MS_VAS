...
//     name: 'filter',
//     required: false,
//     description: 'Filter criteria in the format field:operator:value. Example: city:like:Campinas',
//     example: 'city:like:Campinas'
//   })
//   @ApiQuery({
//     name: 'sort',
//     required: false,
//     description: 'Sorting criteria in the format field:direction. Example: createdAt:desc',
